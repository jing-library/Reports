...
* Black Culture Center Library website started off
* Requested UX tests for the pages Personal Librarians and Software List - reviewed and discussed the test plan
* Maintained job posts, staff directory, and org charts
* Updated the Open Access Award Recipients page
* Helped styling of the chat widget on the OneSearch page
* Updated links to the Development Leave forms
* Updated Arch Library floor plans
...
* CFSA Events (New Year Celebration) preparation and website updates 
* IFLA SE section monthly meeting - section website updates and programs for the upcoming WLIC 2022
* CALA membership database maintanance

## Others
* R workshops preparation, rehearsals, and deliveries (updated LibGuides)
* Annual Review

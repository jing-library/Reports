...
# rename columns
names(scopus_2023_may)[c(1:10)] <- c("author", "title", "year", "source_title", "citations_2023_april", "DOI", "doc_type", "pub_stage", "oa_status_2023_april", "EID")
...
* Number of records (Comparing with 2022 March)
  After removing records with missing DOIs or duplicated DOIs, **9,893 records** were kept. **64 items** were removed from the data set of March 2022 and **169 items** were added. The total data change was **around 2.4%**.
